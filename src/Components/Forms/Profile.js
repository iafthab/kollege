  ...
  return (
    <main>
      ...
      <div className=" my-4 w-full overflow-auto rounded-md border-2 border-slate-900 dark:border-slate-500 dark:p-[1px] md:w-1/2 xl:w-1/3">
        {userType === "teacher" ? (
          <PiUser className="mx-auto my-2 rounded-full border-2 border-slate-900 p-1 text-8xl dark:border-slate-300 md:p-2" />
        ) : (
          <PiStudent className="mx-auto my-2 rounded-full border-2 border-slate-900 p-1 text-8xl font-light dark:border-slate-300 md:p-2" />
        )}
